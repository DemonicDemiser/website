...
<div class="container-fluid">
    ...
    <div class="row d-flex justify-content-around">
        <div class="row d-flex justify-content-around">
            ...
            $table = "SELECT Full_name,Specialty,About,Picture FROM company WHERE People = 'Editor'";
